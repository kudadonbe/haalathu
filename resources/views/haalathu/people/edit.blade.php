            ...
            <form method="POST" action="/haalathu/person/{{ $person->nid }}" enctype="multipart/form-data">
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <input id="name" lang="dv" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') ?? $person->name }}" autocomplete="name" autofocus>
                            @error('name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="row">
                                ...
                                <div class="col">
                                    <input id="house" type="text" class="form-control @error('house') is-invalid @enderror" name="house" value="{{ old('house') ?? $person->house }}" autocomplete="house" autofocus>
                                    @error('house')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-3">
                                    <input id="atoll" type="text" class="form-control @error('atoll') is-invalid @enderror" name="atoll" value="{{ old('atoll') ?? $person->atoll }}" autocomplete="atoll" autofocus>
                                    @error('atoll')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col">
                                    <input id="island" type="text" class="form-control @error('island') is-invalid @enderror" name="island" value="{{ old('island') ?? $person->island }}" autocomplete="island" autofocus>
                                    @error('island')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>

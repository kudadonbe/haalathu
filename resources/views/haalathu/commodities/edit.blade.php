...
<div class="container">
    ...
    <div class="row regform">
        <div class="col-3"></div>
        <div class="col">
            <form method="POST" action="/haalathu/commodity/{{ $commodity->name }}" enctype="multipart/form-data">
                <style>
                    .fst-col,
                    .scn-col {
                        padding-left: 5px;
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <input dir="ltr" id="img_url" type="text" class="form-control @error('img_url') is-invalid @enderror" name="img_url" value="{{ old('img_url') ?? $commodity->img_url }}" autocomplete="img_url" autofocus>
                            @error('img_url')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>

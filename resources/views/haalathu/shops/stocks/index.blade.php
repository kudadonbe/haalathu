...
<div class="container">
    ...
    <div class="row" id="residFrom" style="display: none;">
        <div class="col">
            <form method="POST" action="/haalathu/shop/stock" enctype="multipart/form-data">
                @csrf
                <fieldset>
                    <legend>މިވިޔަފާރިގެޔަށް އިތުރުކުރެވޭ މުދާ</legend>
                    <div class="col-3">

                        <input type="hidden" name="shop_id" value="{{ $shop->id }}">
                    </div>
                    <div class="row">
                        <label class="col-2" for="stock_name">މުދަލުގެ ބާވަތް:</label>
                        <div class="col-3">
    ...
    <div class="row">
        <div class="col">
            <fieldset>
                ...
                <div class="row">
                    <div class="col links">
                        <a href="/haalathu/commodity/{{ $stock->name }}">
                            {{ $stock->name }}
                        </a>
                    </div>
                    <div class="col">{{ $stock->qty }}</div>
                    <div class="col">{{ $stock->unit }}</div>
                </div>
                @endforeach
                <div class="row links">
